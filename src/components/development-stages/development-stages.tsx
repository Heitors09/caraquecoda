...
const DevelopmentStages = () => {
  ...
  return (
    <div id='section-4' className="text-white w-full min-h-screen px-6 md:px-16 lg:px-32 py-24">
  <div className="flex flex-col gap-12 text-sm">
    ...
    <p className="opacity-70 max-w-full md:max-w-[700px]">
  ...
  <div className="bg-[#0D0D0D] shadow-lg w-full p-5 flex flex-col gap-2 rounded-[8px] mt-12">
    <p>Etapas</p>
    ...
    <div className="flex gap-2 flex-nowrap overflow-x-auto">
      ...
      {layout === 'Entrega' ? (
        ...
        <div onClick={() => setLayout('Entrega')} className="min-w-[150px] md:min-w-[180px] lg:min-w-[200px] cursor-pointer clip-box-inward-left rounded-r-[8px] flex items-center justify-center h-12 bg-zinc-800 gap-1 shadow-lg">
