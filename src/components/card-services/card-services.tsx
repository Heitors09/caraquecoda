...
const CardServices = () => {
  ...
  return (
    <div id='section-3' className="h-auto w-full my-16 md:my-32 gap-7 flex flex-col">
  <div className="flex flex-col mx-8 md:mx-32">
    <h3 className="text-3xl md:text-5xl font-bold text-white my-5 flex gap-2">
      Serviços<span className="text-[#FFC700]">disponíveis</span>
    </h3>
    <p className='text-white opacity-70 text-xs md:text-sm'>
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita molestias rerum delectus ea atque dolores. Magni optio, officiis eius alias iusto quisquam perspiciatis, modi repudiandae eligendi quaerat repellendus eos sed modi repudiandae eligendi quaerat repellendus eos sed modi repudiandae eligendi quaerat repellendus eos sed.
    </p>
  </div>
  
  <div className="w-full gap-5 grid px-8 md:px-32 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 my-5">
